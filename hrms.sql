...
BEGIN
	INSERT INTO "public"."users" (email,password) VALUES('emre@emre.com.tr','12345') RETURNING id INTO user_id;
	INSERT INTO "public"."candidates" (id,first_name,last_name,identity_number,birth_date) VALUES(user_id,'emre','çabuk','12312312311','1987-08-16');
END $$;